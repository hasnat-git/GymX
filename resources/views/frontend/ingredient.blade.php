...
@section('main-container')nd -->
      ...
      <main class="fix">
                        ...
                        <div class="eg-breadcrumb__content">
                           ...
                           {{-- <nav aria-label="breadcrumb">
                              <ol class="eg-breadcrumb__list">
                                 ...
                                 <li class="eg-breadcrumb__item active" aria-current="page">ingredient</li>
                              </ol>
                           </nav> --}}
                        </div>
                     </div>
         ...
         <!-- brand area  -->
         <section class="brand__area eg-brand__bg pb-130 scene">
            <div class="container">
               <div class="row">
                  <div class="col-12">
                        ...
                        <div class="eg-feature__thumb-wrap scene">
                           ...
                           <div class="eg-feature__shape">
                              <div class="eg-feature__shape-1">
                                 <img class="layer" data-depth="0.3"  src="assets/img/feature/feature-shape-01.png" alt="feature-shape">
                              </div>
                              <div class="eg-feature__shape-2">
                                 <img class="layer" data-depth="0.3"  src="assets/img/feature/feature-shape-02.png" alt="feature-shape">
                              </div>
                           </div>
                        </div>
                     </div>
         ...
         <!-- feature area end -->
          ...
          <!-- product area -->
          <section class="product__area eg-product__bg fix mt-110">
            <div class="container">
               <div class="row">
                  <div class="col-12">
                     <div class="eg-section text-center">
                        <h2 class="eg-section__title mb-60">BEST SELLING PRODUCT</h2>
                     </div>
                  </div>
               </div>
